#Define Library & Algorithm For Machine Learning
from tkinter import *
...
# Define Stacke Algorithm Generalization
from sklearn.model_selection import train_test_split
...
#Define Algorithm & Fit On Data Diabetes
from sklearn.ensemble import RandomForestClassifier
...
# Difine Excels For Sava Vital_Signs
import statistics
...
# Define Data For Save Member For Parvade Electroinc
def new_user():
...
def Help():
    ...
    #Define Home FAQ ContactUs Help
    def ret():
        root.destroy()
        home()
...
#Define Page Wellcaome Application   
def welcome():
    #loading page
    def task():
...
def Health():
    ...
    def Fdiab():
        ...
        def submit(data):
            ...
            # Define Algorithm For Predict New Data Diabetic
            ...
            # Define Algorithm For Accuracy New Data Diabetic
            ...
            #Save Result Predict Algorithms in Variable
            ...
            #Define For Showing Result OF Algorithms
        ...
        def check():
            if submit([text1.get(),text2.get(),text3.get(),text4.get(),text5.get(),text6.get(),text7.get(),text8.get()]):
                ...
                root.mainloop()
        #Define TEXT FOR ENTER Vital_Singns IN Page
        #1
